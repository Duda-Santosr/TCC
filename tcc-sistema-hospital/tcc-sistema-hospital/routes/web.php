...
Route::middleware('auth:paciente')->group(function () {
    ...
    // Dashboard paciente
    Route::get('/dashboard-paciente', [AuthController::class, 'dashboardPaciente'])
    ...
    Route::get('/formulario-pre-triagem', [PreTriagemController::class, 'index'])
        ->name('formulario.pre-triagem');
    Route::post('/formulario-pre-triagem', [PreTriagemController::class, 'store'])
        ->name('formulario.pre-triagem.store');

    // Página de resultado
    Route::get('/resultado-prioridade/{codigo}', [ResultadoPrioridadeController::class, 'index'])
        ->name('resultado.prioridade');

    // Guia de primeiros socorros — só acessível após login
    Route::get('/guia-primeiros-socorros', function () {
        return view('guia_primeiros_socorros');
...
Route::middleware('auth:funcionario')->group(function () {
    Route::get('/dashboard/funcionario', [FuncionarioLoginController::class, 'dashboard'])
